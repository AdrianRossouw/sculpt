...
/**
 * @file A transform stream that splits streams into chunks of the same size in bytes.
 * Buffer splitting is based on from https://github.com/substack/rolling-hash.
 */
var map = require('./map')
